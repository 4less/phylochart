...
usage <- function() {
  cat(
    paste0(
      "Usage: Rscript export_phyloseq.R --input <phyloseq.rds> --output <taxa.tsv> [--filter-treatment|--no-filter-treatment] [--types relative|absolute|both] [--drop-zeros|--keep-zeros]\n",
